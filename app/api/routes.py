...
# ----- Events (используем EventBrief для списка, создания и обновления) -----
@router.post("/events/", response_model=schemas.EventBrief)
...
@router.get("/events/", response_model=List[schemas.EventBrief])
...
@router.put("/events/{event_id}", response_model=schemas.EventBrief)
...
# ----- Seminars (используем EventBrief) -----
...
# ----- Conferences (используем EventBrief) -----
...
# ----- Corporate Events (используем EventBrief) -----
